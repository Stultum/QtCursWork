...
Rectangle {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            dialogVars.thisSoldDate = solddateModel
    ...
    Rectangle {
        ...
        TextField {
            ...
            color: "#1760A6"
            onTextChanged: {
                SoldModel.updateModelWithSearch(searchField.text)
            }
        }
    ...
    Dialog {
        ...
        Rectangle {
            ...
            Text {
                ...
                text: database.convertDate(dialogVars.thisSoldDate)
